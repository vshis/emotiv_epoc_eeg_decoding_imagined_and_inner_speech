...
if __name__ == '__main__':
    filepath = 'testing_data/thinking_labelled.csv'  # location of the file of interest
    data_mne = load_raw_data(filepath, verbose=False, data_type='my')  # loads data from csv to mne.io.RawArray
